    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsList className="hidden lg:flex w-full h-auto p-2 bg-white border rounded-lg shadow-sm flex-wrap gap-2 justify-center xl:justify-start">
          ...
          <TabsTrigger value="crime" className="min-w-[140px] px-4 py-3 text-sm font-medium rounded-md data-[state=active]:bg-purple-600 data-[state=active]:text-white data-[state=active]:shadow-sm transition-all">
            🚔 Crime
          </TabsTrigger>
